      ...
      <form class="event event--edit" action="#" method="post">
        <header class="event__header">
          ...
          <div class="event__field-group  event__field-group--destination">
            ...
            <input class="event__input  event__input--destination" id="event-destination-1" type="text" name="event-destination" value=${eventDestination.city} list="destination-list-1">
            <datalist id="destination-list-1">
              <option value=${eventDestination.city}></option>
              <option value=${eventDestination.city}></option>
              <option value=${eventDestination.city}></option>
            </datalist>
          </div>
        ...
        <section class="event__details">
          ...
          <section class="event__section  event__section--destination">
            ...
            <p class="event__destination-description">${mockDestination.description}</p>
          </section>
        </section>
      </form>
    </li>`
...
export default class EditPointView {
  ...
  getTemplate() {
    return editPointTemplate(this.event);
  }
